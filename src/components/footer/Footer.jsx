    ...
    return (
        <footer className="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-10">
            <nav className="grid grid-flow-col gap-4">
                <ul className="menu menu-horizontal px-1 text-[17px] text-gray-600 space-x-5">
                    <li>
                        <NavLink
                            to="/"
                            className={({ isActive }) =>
                                isActive ? "text-cyan-500 font-bold" : ""
                            }
                        >
                            Home
                        </NavLink>
            ...
            <aside>
                <p>Copyright © {new Date().getFullYear()} - All right reserved by Hobby Hub Company</p>
            </aside>
        </footer>
    );
};
